...
export const RentalForm = ({ initialData, isEditing = false }: RentalFormProps) => {
  ...
  const onSubmit = async (data: RentalFormData) => {
    ...
    try {
      ...
      if (isEditing) {
        ...
        toast({
          description: "Ижара ийгиликтүү түзүлдү",
        });
      }
      ...
      toast({
        variant: "destructive",
        description: `Ижараны ${isEditing ? "жаңыртууда" : "түзүүдө"} ката кетти: ` + error.message,
      });
    } finally {
      setLoading(false);
    }
    ...
    <Form {...form}>
      <form onSubmit={form.handleSubmit(onSubmit)} className="space-y-6">
        ...
        <FormField
          ...
          render={({ field }) => (
            <FormItem>
              <FormLabel>Ижара аты</FormLabel>
              <FormControl>
                <Input placeholder="Ижарага берилүүчү буюмдун аты" {...field} />
              </FormControl>
              <FormMessage />
            </FormItem>
          )}
        ...
        <FormField
          ...
          render={({ field }) => (
            <FormItem>
              <FormLabel>Техникалык мүнөздөмөлөр</FormLabel>
              <FormControl>
                <Input placeholder="Техникалык мүнөздөмөлөрү" {...field} />
              </FormControl>
              <FormMessage />
            </FormItem>
          )}
        ...
        <FormField
          ...
          render={({ field }) => (
            <FormItem>
              ...
              <FormControl>
                <Textarea
                  placeholder="Буюм жөнүндө кошумча маалымат"
                  className="min-h-32"
                  {...field}
                />
              </FormControl>
          ...
          <FormField
            ...
            render={({ field }) => (
              <FormItem>
                ...
                <FormControl>
                  <Input placeholder="Мисалы: Күнүнө 3000 сом" {...field} />
                </FormControl>
                <FormMessage />
              </FormItem>
            )}
